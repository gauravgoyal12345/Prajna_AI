        ...
        <div className="custom-navbar">
            <div className="custom-nav-left">
                <ul className="custom-nav-links">
                    <RoundedButton routeLink = "/" label = "Home" style={{ backgroundColor: 'black', color: 'white' }} />
                    <RoundedButton routeLink = "#about" label = "Home" style={{ backgroundColor: 'black', color: 'white' }} />
                </ul>
            </div>
